...
public class ABCGuideHelper {
    ...
    public ABCGuideHelper addPage(TipData... tipDatas) {
     ...
     * @return
     */
    public ABCGuideHelper addPage(boolean clickDoNext, TipData... tipDatas) {
        return addPage(clickDoNext, null, tipDatas);
    }

    public ABCGuideHelper addPage(boolean clickDoNext, OnClickListener onClickPageListener, TipData... tipDatas) {
    ...
    public ABCGuideHelper show(boolean autoPlay) {
        ...
        //创建dialog
        layout = new ABCInnerChildRelativeLayout(activity);
